...
void TestPiece::test_piece_position()
{
    ...
    auto piece_1 = std::make_unique<Pawn>(A1, Color::White);
    auto piece_2 = std::make_unique<Pawn>(H8, Color::Black);
...
void TestPiece::test_piece_color()
{
    ...
    auto piece_1 = std::make_unique<Pawn>(Position(Col::A, Row::One), color_white);
    auto piece_2 = std::make_unique<Pawn>(Position(Col::A, Row::One), color_black);
...
{
    auto piece_1 = std::make_unique<Pawn>(Position(Col::A, Row::One), Color::White);
    auto piece_2 = std::make_unique<Bishop>(Position(Col::A, Row::One), Color::Black);
...
void TestPiece::test_change_position()
{
    ...
    auto piece_1 = std::make_unique<Pawn>(pos_begin, Color::White);
